...
|Edad < 16 and Habilidad = Baja → Altura < 175|||||
...
### 8. Perceptrón
 Utilizando la numerización de datos generada anteriormente, y dado un modelo de perceptrón donde los pesos son *w=[12, 2, 106]* (para los atributos Edad, Altura, Habilidad, respectivamente) y *sesgo=746*:
