...
|----------|----------|----------|----------|----------|
|1|157|8|Alta|Deportivo|
|2|132|2|Alta|Utilitario|
|3|162|11|Baja|Deportivo|
|4|150|4|Media|Utilitario|
|5|147|8|Alta|Utilitario|
|6|148|4|Alta|Deportivo|
|7|163|5|Media|Deportivo|
|8|161|4|Alta|Utilitario|


### 1. Discretización de atributos (puntos: 1)
 Resultado de la discretización por rango:

Valores: [3, 0, 3, 2, 1, 2, 3, 3]

Intervalos: [[132.0,139.75), [139.75,147.5), [147.5,155.25), [155.25,163.0]]

Resultado de la discretización por frecuencia:

Valores: [2, 0, 3, 1, 0, 1, 3, 2]

Intervalos: [[132,148), [148,157), [157,162), [162,163]]

### 2. Normalización de atributos (puntos: 1)
 Normalización rango con transformación (x-2.00)/9.00

Valores normalizados: 0.67, 0.00, 1.00, 0.22, 0.67, 0.22, 0.33, 0.22

### 3. Métricas de Reglas (puntos: 1)
 
|Regla|Soporte|Cobertura|Confianza|Interés|
|----------|----------|----------|----------|----------|
|Antigüedad = Alta → Clase = Deportivo|0.25|0.62|0.40|0.80|
|Clase = Utilitario → Antigüedad = Media|0.12|0.50|0.25|1.00|
|Velocidad < 152 and Antigüedad = Baja → Cilindros < 6|0.00|0.00|1.00|inf|
...
|Antigüedad = Alta → Clase = Utilitario|0.60|5|


### 5. Numerización de datos (puntos: 1)
 Valores originales: ['Alta', 'Alta', 'Baja', 'Media', 'Alta', 'Alta', 'Media', 'Alta']


Valores nuevos: [3, 3, 1, 2, 3, 3, 2, 3]
...
|----------|----------|----------|----------|----------|
|1|157|8|3|Deportivo|
|2|132|2|3|Utilitario|
|3|162|11|1|Deportivo|
|4|150|4|2|Utilitario|
|5|147|8|3|Utilitario|
|6|148|4|3|Deportivo|
|7|163|5|2|Deportivo|
|8|161|4|3|Utilitario|
