...
|----------|----------|----------|----------|----------|
|1|158|6|Media|Utilitario|
|2|154|5|Media|Utilitario|
|3|150|11|Media|Deportivo|
|4|142|7|Baja|Deportivo|
|5|162|13|Alta|Utilitario|
|6|143|10|Baja|Deportivo|
|7|177|10|Media|Deportivo|
|8|158|12|Baja|Utilitario|


### 1. Discretización de atributos (puntos: 1)
 Resultado de la discretización por rango:

Valores: [1, 1, 0, 0, 2, 0, 3, 1]

Intervalos: [[142.0,150.75), [150.75,159.5), [159.5,168.25), [168.25,177.0]]

Resultado de la discretización por frecuencia:

Valores: [2, 1, 1, 0, 3, 0, 3, 2]

Intervalos: [[142,150), [150,158), [158,162), [162,177]]

### 2. Normalización de atributos (puntos: 1)
 Normalización rango con transformación (x-5.00)/8.00

Valores normalizados: 0.12, 0.00, 0.75, 0.25, 1.00, 0.62, 0.62, 0.88

### 3. Métricas de Reglas (puntos: 1)
 
|Regla|Soporte|Cobertura|Confianza|Interés|
|----------|----------|----------|----------|----------|
|Antigüedad = Alta → Clase = Deportivo|0.00|0.12|0.00|0.00|
|Clase = Deportivo → Antigüedad = Baja|0.25|0.50|0.50|1.33|
|Velocidad < 156 and Antigüedad = Media → Cilindros < 9|0.12|0.25|0.50|1.33|
...
|Velocidad = Alta → Clase = Utilitario|0.75|4|
...
### 5. Numerización de datos (puntos: 1)
 Valores originales: ['Media', 'Media', 'Media', 'Baja', 'Alta', 'Baja', 'Media', 'Baja']


Valores nuevos: [2, 2, 2, 1, 3, 1, 2, 1]



|Fila|Velocidad|Cilindros|Antigüedad|Clase|
|----------|----------|----------|----------|----------|
|1|158|6|2|Utilitario|
|2|154|5|2|Utilitario|
|3|150|11|2|Deportivo|
|4|142|7|1|Deportivo|
|5|162|13|3|Utilitario|
|6|143|10|1|Deportivo|
|7|177|10|2|Deportivo|
|8|158|12|1|Utilitario|
