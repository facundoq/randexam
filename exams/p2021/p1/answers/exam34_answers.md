...
Valores: [1, 3, 1, 1, 1, 0, 2, 3]

Intervalos: [[139.0,147.5), [147.5,156.0), [156.0,164.5), [164.5,173.0]]

Resultado de la discretización por frecuencia:

Valores: [0, 3, 2, 1, 2, 0, 2, 3]

Intervalos: [[139,153), [153,154), [154,168), [168,173]]

### 2. Normalización de atributos (puntos: 1)
 Normalización rango con transformación (x-2.00)/13.00

Valores normalizados: 0.00, 1.00, 0.62, 0.38, 0.62, 0.77, 0.92, 0.00

### 3. Métricas de Reglas (puntos: 1)
 
|Regla|Soporte|Cobertura|Confianza|Interés|
|----------|----------|----------|----------|----------|
|Antigüedad = Media → Clase = Deportivo|0.12|0.12|1.00|2.67|
|Clase = Deportivo → Antigüedad = Media|0.12|0.38|0.33|2.67|
|Velocidad < 157 and Antigüedad = Baja → Cilindros < 9|0.12|0.38|0.33|0.89|
...
### 5. Numerización de datos (puntos: 1)
 Valores originales: ['Alta', 'Alta', 'Media', 'Baja', 'Baja', 'Baja', 'Alta', 'Alta']


Valores nuevos: [3, 3, 2, 1, 1, 1, 3, 3]
...
|----------|----------|----------|----------|----------|
|1|152|2|3|Deportivo|
|2|168|15|3|Utilitario|
|3|154|10|2|Deportivo|
|4|153|7|1|Deportivo|
|5|154|10|1|Utilitario|
|6|139|12|1|Utilitario|
|7|162|14|3|Utilitario|
|8|173|2|3|Utilitario|
