...
|----------|----------|----------|----------|----------|
|1|170|15|Media|Utilitario|
|2|140|5|Baja|Utilitario|
|3|195|10|Media|Deportivo|
|4|162|8|Alta|Utilitario|
|5|159|2|Media|Utilitario|
|6|149|2|Baja|Utilitario|
|7|139|13|Alta|Deportivo|
|8|136|10|Baja|Utilitario|


### 1. Discretización de atributos (puntos: 1)
 Resultado de la discretización por rango:

Valores: [2, 0, 3, 1, 1, 0, 0, 0]

Intervalos: [[136.0,150.75), [150.75,165.5), [165.5,180.25), [180.25,195.0]]

Resultado de la discretización por frecuencia:

Valores: [3, 1, 3, 2, 2, 1, 0, 0]

Intervalos: [[136,140), [140,159), [159,170), [170,195]]

### 2. Normalización de atributos (puntos: 1)
 Normalización rango con transformación (x-2.00)/13.00

Valores normalizados: 1.00, 0.23, 0.62, 0.46, 0.00, 0.00, 0.85, 0.62
...
|Clase = Deportivo → Antigüedad = Alta|0.12|0.25|0.50|2.00|
|Velocidad < 156 and Antigüedad = Baja → Cilindros < 8|0.25|0.38|0.67|1.78|
...
### 5. Numerización de datos (puntos: 1)
 Valores originales: ['Media', 'Baja', 'Media', 'Alta', 'Media', 'Baja', 'Alta', 'Baja']


Valores nuevos: [2, 1, 2, 3, 2, 1, 3, 1]



|Fila|Velocidad|Cilindros|Antigüedad|Clase|
|----------|----------|----------|----------|----------|
|1|170|15|2|Utilitario|
|2|140|5|1|Utilitario|
|3|195|10|2|Deportivo|
|4|162|8|3|Utilitario|
|5|159|2|2|Utilitario|
|6|149|2|1|Utilitario|
|7|139|13|3|Deportivo|
|8|136|10|1|Utilitario|
