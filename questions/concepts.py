...
QA("Dado un conjunto de datos con 3 clases y 5 atributos nominales. Si se entrena un árbol de clasificación con este conjunto de datos, y solo cuento con esta información ¿puedo saber cuántos nodos tendrá como máximo el árbol?",
