...
class Discretization(DataQuestion):
    ...
    def __init__(self,d:Dataset,attribute_index:int,values:list):
        super().__init__(d)
    ...
    def generate(self, seed=None):
        ...
        q=Paragraphs([Text(f"Discretice el atributo {self.d.attributes[attribute_index]}  por a) frecuencia y b) rango en los valores {self.values}. En ambos casos, indique los intervalos resultantes. Realice un gráfico de barras para visualizar la frecuencia de los valores resultantes.\n\n Nota: La discretización es solo para este ejercicio; utilizar los datos originales en los siguientes.")])
