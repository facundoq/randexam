...
|----------|----------|----------|----------|----------|
|1|138|15|Media|Deportivo|
|2|143|15|Media|Deportivo|
|3|151|5|Media|Utilitario|
|4|163|10|Media|Deportivo|
|5|150|8|Media|Deportivo|
|6|153|11|Baja|Deportivo|
|7|150|6|Alta|Utilitario|
|8|152|8|Media|Utilitario|


### 1. Discretización de atributos (puntos: 1)
 Resultado de la discretización por rango:

Valores: [0, 0, 2, 3, 1, 2, 1, 2]

Intervalos: [[138.0,144.25), [144.25,150.5), [150.5,156.75), [156.75,163.0]]

Resultado de la discretización por frecuencia:

Valores: [0, 0, 2, 3, 1, 3, 1, 2]

Intervalos: [[138,150), [150,151), [151,153), [153,163]]

### 2. Normalización de atributos (puntos: 1)
 Normalización rango con transformación (x-5.00)/10.00

Valores normalizados: 1.00, 1.00, 0.00, 0.50, 0.30, 0.60, 0.10, 0.30

### 3. Métricas de Reglas (puntos: 1)
 
|Regla|Soporte|Cobertura|Confianza|Interés|
|----------|----------|----------|----------|----------|
|Antigüedad = Baja → Clase = Deportivo|0.12|0.12|1.00|1.60|
|Clase = Deportivo → Antigüedad = Alta|0.00|0.62|0.00|0.00|
|Velocidad < 150 and Antigüedad = Alta → Cilindros < 10|0.00|0.00|1.00|inf|
...
|----------|----------|----------|
|Antigüedad = Media → Clase = Deportivo|0.67|6|
|Antigüedad = Baja → Clase = Deportivo|1.00|1|
|Antigüedad = Alta → Clase = Utilitario|1.00|1|


### 5. Numerización de datos (puntos: 1)
 Valores originales: ['Media', 'Media', 'Media', 'Media', 'Media', 'Baja', 'Alta', 'Media']


Valores nuevos: [2, 2, 2, 2, 2, 1, 3, 2]



|Fila|Velocidad|Cilindros|Antigüedad|Clase|
|----------|----------|----------|----------|----------|
|1|138|15|2|Deportivo|
|2|143|15|2|Deportivo|
|3|151|5|2|Utilitario|
|4|163|10|2|Deportivo|
|5|150|8|2|Deportivo|
|6|153|11|1|Deportivo|
|7|150|6|3|Utilitario|
|8|152|8|2|Utilitario|
