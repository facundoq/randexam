...
|----------|----------|----------|----------|----------|
|1|182|2|Baja|Utilitario|
|2|121|11|Baja|Deportivo|
|3|140|12|Alta|Deportivo|
|4|163|15|Media|Deportivo|
|5|187|4|Media|Deportivo|
|6|146|10|Baja|Utilitario|
|7|150|6|Alta|Utilitario|
|8|146|15|Alta|Utilitario|


### 1. Discretización de atributos (puntos: 1)
 Resultado de la discretización por rango:

Valores: [3, 0, 1, 2, 3, 1, 1, 1]

Intervalos: [[121.0,137.5), [137.5,154.0), [154.0,170.5), [170.5,187.0]]

Resultado de la discretización por frecuencia:

Valores: [3, 0, 0, 2, 3, 1, 2, 1]

Intervalos: [[121,146), [146,150), [150,182), [182,187]]

### 2. Normalización de atributos (puntos: 1)
 Normalización rango con transformación (x-2.00)/13.00

Valores normalizados: 0.00, 0.69, 0.77, 1.00, 0.15, 0.62, 0.31, 1.00

### 3. Métricas de Reglas (puntos: 1)
 
|Regla|Soporte|Cobertura|Confianza|Interés|
|----------|----------|----------|----------|----------|
|Antigüedad = Media → Clase = Deportivo|0.25|0.25|1.00|2.00|
...
|----------|----------|----------|
|Velocidad = Media → Clase = Utilitario|1.00|3|
...
### 5. Numerización de datos (puntos: 1)
 Valores originales: ['Baja', 'Baja', 'Alta', 'Media', 'Media', 'Baja', 'Alta', 'Alta']


Valores nuevos: [1, 1, 3, 2, 2, 1, 3, 3]



|Fila|Velocidad|Cilindros|Antigüedad|Clase|
|----------|----------|----------|----------|----------|
|1|182|2|1|Utilitario|
|2|121|11|1|Deportivo|
|3|140|12|3|Deportivo|
|4|163|15|2|Deportivo|
|5|187|4|2|Deportivo|
|6|146|10|1|Utilitario|
|7|150|6|3|Utilitario|
|8|146|15|3|Utilitario|
