...
|----------|----------|----------|----------|----------|
|1|133|10|Alta|Deportivo|
|2|151|10|Baja|Deportivo|
|3|147|7|Alta|Utilitario|
|4|149|14|Media|Deportivo|
|5|157|9|Media|Utilitario|
|6|139|9|Media|Utilitario|
|7|148|15|Baja|Deportivo|
|8|145|4|Baja|Utilitario|


### 1. Discretización de atributos (puntos: 1)
 Resultado de la discretización por rango:

Valores: [0, 3, 2, 2, 3, 1, 2, 2]

Intervalos: [[133.0,139.0), [139.0,145.0), [145.0,151.0), [151.0,157.0]]

Resultado de la discretización por frecuencia:

Valores: [0, 3, 1, 2, 3, 0, 2, 1]

Intervalos: [[133,145), [145,148), [148,151), [151,157]]

### 2. Normalización de atributos (puntos: 1)
 Normalización rango con transformación (x-4.00)/11.00

Valores normalizados: 0.55, 0.55, 0.27, 0.91, 0.45, 0.45, 1.00, 0.00
...
|Clase = Utilitario → Antigüedad = Alta|0.12|0.50|0.25|1.00|
|Velocidad < 146 and Antigüedad = Alta → Cilindros < 10|0.00|0.12|0.00|0.00|
...
### 5. Numerización de datos (puntos: 1)
 Valores originales: ['Alta', 'Baja', 'Alta', 'Media', 'Media', 'Media', 'Baja', 'Baja']


Valores nuevos: [3, 1, 3, 2, 2, 2, 1, 1]



|Fila|Velocidad|Cilindros|Antigüedad|Clase|
|----------|----------|----------|----------|----------|
|1|133|10|3|Deportivo|
|2|151|10|1|Deportivo|
|3|147|7|3|Utilitario|
|4|149|14|2|Deportivo|
|5|157|9|2|Utilitario|
|6|139|9|2|Utilitario|
|7|148|15|1|Deportivo|
|8|145|4|1|Utilitario|
