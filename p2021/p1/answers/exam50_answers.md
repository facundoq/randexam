...
|----------|----------|----------|----------|----------|
|1|142|4|Media|Utilitario|
|2|157|13|Alta|Deportivo|
|3|134|3|Alta|Utilitario|
|4|161|6|Baja|Utilitario|
|5|121|3|Media|Deportivo|
|6|163|11|Media|Utilitario|
|7|149|3|Alta|Utilitario|
|8|181|11|Media|Utilitario|


### 1. Discretización de atributos (puntos: 1)
 Resultado de la discretización por rango:

Valores: [1, 2, 0, 2, 0, 2, 1, 3]

Intervalos: [[121.0,136.0), [136.0,151.0), [151.0,166.0), [166.0,181.0]]

Resultado de la discretización por frecuencia:

Valores: [1, 2, 0, 2, 0, 3, 1, 3]

Intervalos: [[121,142), [142,157), [157,163), [163,181]]

### 2. Normalización de atributos (puntos: 1)
 Normalización rango con transformación (x-3.00)/10.00

Valores normalizados: 0.10, 1.00, 0.00, 0.30, 0.00, 0.80, 0.00, 0.80
...
|Velocidad < 151 and Antigüedad = Media → Cilindros < 7|0.25|0.25|1.00|1.60|
...
|----------|----------|----------|
|Antigüedad = Media → Clase = Utilitario|0.75|4|
|Antigüedad = Baja → Clase = Utilitario|1.00|1|
|Antigüedad = Alta → Clase = Utilitario|0.67|3|


### 5. Numerización de datos (puntos: 1)
 Valores originales: ['Media', 'Alta', 'Alta', 'Baja', 'Media', 'Media', 'Alta', 'Media']


Valores nuevos: [2, 3, 3, 1, 2, 2, 3, 2]



|Fila|Velocidad|Cilindros|Antigüedad|Clase|
|----------|----------|----------|----------|----------|
|1|142|4|2|Utilitario|
|2|157|13|3|Deportivo|
|3|134|3|3|Utilitario|
|4|161|6|1|Utilitario|
|5|121|3|2|Deportivo|
|6|163|11|2|Utilitario|
|7|149|3|3|Utilitario|
|8|181|11|2|Utilitario|
