...
|Edad < 18 and Habilidad = Baja → Altura < 169|||||
...
### 8. Perceptrón
 Utilizando la numerización de datos generada anteriormente, y dado un modelo de perceptrón donde los pesos son *w=[10, 2, 93]* (para los atributos Edad, Altura, Habilidad, respectivamente) y *sesgo=717*:
