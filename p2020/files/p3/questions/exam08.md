...
|Edad < 17 and Habilidad = Baja → Altura < 164|||||
...
### 8. Perceptrón
 Utilizando la numerización de datos generada anteriormente, y dado un modelo de perceptrón donde los pesos son *w=[6, 1, 50]* (para los atributos Edad, Altura, Habilidad, respectivamente) y *sesgo=365*:
